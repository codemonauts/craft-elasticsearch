...
/**
 * Lab-Testroutine für codemonauts/craft-elasticsearch (Craft 4).
 *
 ...
 *   via Craft::$app->getSearch())? Zwei Craft-4-Weichen greifen hier:
 ...
 *     (b) Craft 4 ruft den ES-Override searchElements() laut ElementQuery nur auf,
...
return function (Controller $c): int {
    ...
    // Reale UI-Suche über Craft::$app->getSearch(). $byScore steuert die Craft-4-Weiche:
